...
public:
   ...
   */
    ...
    virtual std::any visitAddExpConst(HelloParser::AddExpConstContext *context) = 0;

    virtual std::any visitMulExpConst(HelloParser::MulExpConstContext *context) = 0;

    virtual std::any visitUnaryExpConst(HelloParser::UnaryExpConstContext *context) = 0;

    virtual std::any visitPrimaryExpConst(HelloParser::PrimaryExpConstContext *context) = 0;
    ...
    virtual std::any visitCharacter(HelloParser::CharacterContext *context) = 0;
