...
public:
  ...
  virtual std::any visitAddExpConst(HelloParser::AddExpConstContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitMulExpConst(HelloParser::MulExpConstContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitUnaryExpConst(HelloParser::UnaryExpConstContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitPrimaryExpConst(HelloParser::PrimaryExpConstContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitCharacter(HelloParser::CharacterContext *ctx) override {
    return visitChildren(ctx);
  }
